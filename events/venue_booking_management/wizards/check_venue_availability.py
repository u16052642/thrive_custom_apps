...
class VenueAvailable(models.TransientModel):
    ...
    budget = fields.Float(string="Booking Amount Budget",
                          help='We can check the budget amount')
    capacity = fields.Float(string="Capacity",
                            help='Venue capacity for the Booking')

    def action_search_venue(self):
        """"The button to search for bookings and check the bookings
        availability"""
