...
# Part of BrowseInfo. See LICENSE file for full copyright and licensing details.
{
	...
	"description":"""
		...
		Lot Expiry Track Report thrive App helps users to generate report of expiration of lot and serial number. User can easily track lot and serial number expiry and print expiry report in PDF format which is based on product and serial number.
