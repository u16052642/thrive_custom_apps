...
class Builder(models.Model):
    ...
    def _get_js_params(self):
        """ thrive JS (Owl component) misc. params """
        params = {
    ...
    def _etl_thrive_config(self, formio_form=None, params={}):
        return {}

    def _etl_thrive_data(self, formio_form=None, params={}):
        return {}

    def _generate_thrive_domain(self, domain=[], params={}):
        return domain
