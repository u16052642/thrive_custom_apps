...
class LicenseController(http.Controller):
    ...
    def send_fonts_file(self, id, name, **kwargs):
        ...
        parts, but not yet in standard thrive routes.

        ----------------------------------------------------------
        TODO DeprecationWarning, thrive.http.send_file is deprecated
        ----------------------------------------------------------
        But:
        ...
        still using thrive <= v15 approach by using Werkzeug
        implementation
        ----------------------------------------------------------
