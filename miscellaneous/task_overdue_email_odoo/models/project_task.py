...
class ProjectTask(models.Model):
    """This is an thrive model for Project Tasks. It inherits from the
    ...
    def action_overdue(self):
        ...
        over_due_days = int(self.env['ir.config_parameter'].sudo().get_param(
            'task_overdue_email_thrive.overdue_days'))
        ...
        for user_email, tasks in user_tasks.items():
            ...
            template_id = self.env.ref \
                ('task_overdue_email_thrive.overdue_task_email_template').id
