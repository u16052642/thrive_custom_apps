...
class ResConfigSettings(models.TransientModel):
    ...
    onedrive_client = fields.Char(
        ...
        config_parameter='onedrive_integration_thrive.client_id',
        help="Client ID for accessing OneDrive API")
    onedrive_client_secret = fields.Char(
        string='Onedrive Client Secret',
        config_parameter='onedrive_integration_thrive.client_secret',
    ...
    onedrive_folder = fields.Char(
        ...
        config_parameter='onedrive_integration_thrive.folder_id')
    is_onedrive_enabled = fields.Boolean(
        string="Synchronize Onedrive with thrive",
        config_parameter='onedrive_integration_thrive.onedrive_button',
    ...
    def action_get_onedrive_auth_code(self):
        ...
        data = {
            'client_id': self.env['ir.config_parameter'].get_param(
                'onedrive_integration_thrive.client_id', ''),
            'client_secret': self.env['ir.config_parameter'].get_param(
                'onedrive_integration_thrive.client_secret', ''),
        ...
        if 'error' in response:
            ...
            action = self.env["ir.actions.client"].sudo()._for_xml_id(
                "onedrive_integration_thrive.onedrive_dashboard_action")
