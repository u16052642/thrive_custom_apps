...
###############################################################################
{
    ...
    'summary': """Database Restore Manager,Restore Manager,thrive Database Backup, Automatic Backup, Database Backup, Automatic Backup,Database auto-backup, thrive backup'
               'google drive, dropbox, nextcloud, amazon S3, onedrive or '
               'remote server, thrive17""",
    ...
    'assets': {
        'web.assets_backend': [
            '/thrive_database_restore_manager/static/src/js/restore.js',
            '/thrive_database_restore_manager/static/src/xml/db_restore_dashboard_templates.xml',
            '/thrive_database_restore_manager/static/src/scss/db_restore.scss'
        ]
    },
