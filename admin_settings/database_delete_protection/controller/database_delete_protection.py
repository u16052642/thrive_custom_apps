...
#
#############################################################################
from thrive.addons.web.controllers import database
import thrive
...
class Database(database.Database):
    ...
    def _render_template(self, **d):
        ...
        db_to_restrict_delete = thrive.tools.config.get('db_delete_restrict',
                                                      False)
        ...
        try:
            ...
            d['incompatible_databases'] = thrive.service.db.list_db_incompatible(
                d['databases'])
