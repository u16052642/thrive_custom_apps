...
.. _`Odoo Magento Connector`: http://www.thrive-magento-connector.com
...
* Delay a job (see the decorator :py:func:`~thrive.addons.queue_job.job.job`)
...
:class:`thrive.addons.component.models.collection.Collection` which has a
:meth:`thrive.addons.component.models.collection.Collection.work_on` that will be
...
Reference: :class:`~thrive.addons.component.core.WorkContext`

A :class:`~thrive.addons.component.core.WorkContext` is the work environment or
context that will be passed transversally through all the components. This is
also the entrypoint to the component system.

A connectors developer is mostly interested by:

* Get a Component from a WorkContext (:py:meth:`~thrive.addons.component.core.WorkContext.component`)
...
:py:class:`~thrive.addons.component.core.Component` are pluggable classes used
