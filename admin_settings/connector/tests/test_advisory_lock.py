...
from thrive.addons.component.core import WorkContext
from thrive.addons.component.tests.common import TransactionComponentCase
from thrive.addons.connector.database import pg_try_advisory_lock
from thrive.addons.queue_job.exception import RetryableJobError
...
class TestAdvisoryLock(TransactionComponentCase):
    ...
    def test_concurrent_import_lock(self):
        ...
        # instanciate another component using a different thrive env
