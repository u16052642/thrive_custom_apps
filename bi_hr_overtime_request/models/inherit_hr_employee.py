...
class Hr_employee_inherit_(models.Model):
    ...
    def get_overtime(self,id,start_date,end_date):
        ...
        over_time_rec = self.env['overtime.request'].search([('employee_id','=',self.id),('start_date','>=',start_date),('include_in_payroll','=',True),
...
class HrContract(models.Model):
    ...
    overtime_rate = fields.Float(string='Overtime Per Hour Rate')