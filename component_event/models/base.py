...
from thrive.addons.component.core import _component_databases
    ...
    * ``on_record_unlink(self, record)``
    ...
    def _event(self, name, collection=None, components_registry=None):
        ...
        :type components_registry:
            :class:`thrive.addons.components.core.ComponentRegistry`
        ...
        if not comp_registry or not comp_registry.ready:
            ...
            # This is a very special case, when the thrive registry is being
            # built, it calls thrive.modules.loading.load_modules().
