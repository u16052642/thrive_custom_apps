...
#    Author: Bhagyadev KP (thrive@cybrosys.com)
#
...
################################################################################
{
    ...
    'description': 'This module allow to print complete fleet report, Which'
                   ' will show vehicle details, contract details, services and'
                   ' driver history',
