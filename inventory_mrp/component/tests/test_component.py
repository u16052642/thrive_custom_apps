...
from thrive.addons.component.exception import NoComponentError, SeveralComponentError
...
class TestComponent(TransactionComponentRegistryCase):
    ...
    We test the chain thrive Model -> generate a WorkContext instance -> Work
    with Component.
