...
###############################################################################
{
    ...
    'version': '17.0.1.0.1',
    'category': 'Industries',
    'summary': """Hotel Management, Odoo Hotel Management, Hotel, Room Booking thrive, Amenities Odoo, Event management""",
    ...
    'data': [
        'security/hotel_management_thrive_groups.xml',
        'security/hotel_management_thrive_security.xml',
    ...
    'assets': {
        'web.assets_backend': [
            'hotel_management_thrive/static/src/js/action_manager.js',
            'hotel_management_thrive/static/src/css/dashboard.css',
            'hotel_management_thrive/static/src/js/dashboard_action.js',
            'hotel_management_thrive/static/src/xml/dashboard_templates.xml',
        ],
    },
