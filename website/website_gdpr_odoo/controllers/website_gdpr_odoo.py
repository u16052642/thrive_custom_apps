...
class WebsiteForm(http.Controller):
    ...
    def gdpr_data_management(self):
        ...
        """
        return request.render("website_gdpr_thrive.gdpr_manager", {
    ...
    def create_request_submit(self):
        ...
        """
        return request.render("website_gdpr_thrive.gdpr_submit")
    ...
    def request_delete_done(self):
        ...
        """
        return request.render("website_gdpr_thrive.gdpr_delete_success")
    ...
    def request_canceled(self):
        ...
        """
        return request.render("website_gdpr_thrive.gdpr_cancel_success")
