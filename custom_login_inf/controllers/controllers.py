...
from thrive.http import content_disposition, request, Response
# from thrive.service import dispatch_rpc
...
class Home(http.Controller):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        if not request.uid:
            request.uid = thrive.SUPERUSER_ID
        ...
        if style == 'default' or style is False:
            ...
            response = request.render('thrive_custom_login_inf.left_login_template', values)
        elif style == 'right':
            response = request.render('thrive_custom_login_inf.right_login_template', values)
        else:
            response = request.render('thrive_custom_login_inf.middle_login_template', values)
