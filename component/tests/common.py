...
from thrive.addons.component.core import ComponentRegistry, MetaComponent, _get_addon_name
...
class ComponentRegistryCase:
    ...
    * :class:`TransactionComponentCase`
    ...
    :class:`thrive.addons.component.core.ComponentRegistry` for the purpose of
