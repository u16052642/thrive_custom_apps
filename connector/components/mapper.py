...
from thrive.addons.component.exception import NoComponentError
...
class Mapper(AbstractComponent):
    ...
    Submappings
        ...
        same call to :py:meth:`thrive.models.BaseModel.create()`.
    ...
    def _build_mapper_component(cls):
        ...
        * "real" Python classes applied on top of existing components (here
        ...
        ::
            ...
            >>> cls.__bases__
            (<class 'thrive.addons.connector.tests.test_mapper.ThirdMapper'>,
             <class 'thrive.addons.component.core.second.mapper'>,
             <class 'thrive.addons.component.core.base'>)
