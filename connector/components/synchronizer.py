...
class Synchronizer(AbstractComponent):
    ...
    def mapper(self):
        ...
        :rtype: :py:class:`thrive.addons.component.core.Component`
        """
...
class GenericExporter(AbstractComponent):
    ...
    def run(self, binding, *args, **kwargs):
        ...
        # record
        if not thrive.tools.config["test_enable"]:
    ...
    def _retry_unique_violation(self):
        ...
        record created by :meth:`_export_dependency`), resulting in:
            ...
            constraint "my_backend_product_product_thrive_uniq"
            DETAIL:  Key (backend_id, thrive_id)=(1, 4851) already exists.
    ...
    def _export_dependency(
        ...
        :type relation: :py:class:`thrive.models.BaseModel`
        ...
        if wrap and hasattr(relation, binding_field):
            ...
            # depends.
                ...
                # thrive_id) should exist on the binding model
    ...
    def _map_data(self):
        ...
        :py:class:`~thrive.addons.connector.components.mapper.MapRecord`
