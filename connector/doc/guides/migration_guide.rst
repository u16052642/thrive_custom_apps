...
.. code-block:: python
    ...
    from thrive.addons.connector.queue.job import job, related_action
...
.. code-block:: python
    ...
    from thrive.addons.queue_job.job import job, related_action
...
* :meth:`thrive.addons.queue_job.job.job`
* :meth:`thrive.addons.queue_job.job.related_action`
...
.. code-block:: python
    ...
    from thrive.addons.connector.session import ConnectorSession
...
* :meth:`thrive.addons.queue_job.job.job`
* :meth:`thrive.addons.queue_job.models.base.Base.with_delay`
...
First you had to create an :class:`~thrive.addons.connector.event.Event` instance:
...
.. code-block:: python
    ...
    from thrive.addons.connector.event import on_record_create
...
* No more imports are needed for the invocation
  ...
  :meth:`thrive.addons.component_event.components.event.CollectedEvents.notify`.
* The name of the event must start with ``'on_'``

Links
-----

* :mod:`thrive.addons.component_event.components.event`
...
* The check of the key ``connector_no_export`` in the context can
  be replaced by the decorator :func:`thrive.addons.component_event.skip_if`
...
* Backend Models are based on Component's Collections:
  :class:`thrive.addons.component.models.collection.Collection`
...
* All components have a Python inheritance on
  :class:`~thrive.addons.component.core.AbstractComponent` or
  :class:`~thrive.addons.component.core.Component`
...
* :ref:`api-component`
* :class:`thrive.addons.component.core.AbstractComponent`
...
.. code-block:: python
    ...
    from thrive.addons.connector.connector import ConnectorEnvironment
...
* :class:`~thrive.addons.component.core.WorkContext`
...
.. code-block:: python
    ...
    from thrive.addons.magentoerpconnect.backend import magento1700, magento1900
