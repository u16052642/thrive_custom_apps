...
MANIFEST_FILES = ["__manifest__.py", "__thrive__.py", "__openerp__.py"]


def is_module(path):
    """return False if the path doesn't contain an thrive module, and the full
...
def is_installable_module(path):
    """return False if the path doesn't contain an installable thrive module,
...
if os.environ.get("TRAVIS_BUILD_DIR") and os.environ.get("VERSION"):
    ...
    thrive_folder = "thrive-" + os.environ.get("VERSION")
    thrive_root = os.path.join(repos_home, thrive_folder)
    build_path = os.environ["TRAVIS_BUILD_DIR"]
else:
    # build from dev
    thrive_root = os.path.abspath("../../../../src")
...
add_path(thrive_root, "thrive", "addons")
add_path(thrive_root, "addons")
add_path(build_path)
...
# sphinxthrive.ext.autodoc variables
sphinxthrive_root_path = thrive_root
sphinxthrive_addons = addons
sphinxthrive_addons_path = addons_paths
...
intersphinx_mapping = {
    ...
    "thriveweb": ("https://www.thrive.com/documentation/10.0/", None),
    "thrivedev": ("https://www.thrive.com/documentation/10.0/", None),
    "connectormagento": ("http://www.thrive-magento-connector.com", None),
}
