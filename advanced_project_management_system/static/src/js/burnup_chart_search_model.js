...
export class BurnupChartSearchModel extends SearchModel {
    /**
     * @override
     */
    setup(services) {
    ...
    /**
     * Adds a notification relative to the group by constraint of the Burnup Chart.
     * @param fieldName The field name(s) the notification has to be related to.
     * @private
     */
    _addGroupByNotification(fieldName) {
        const notif = _t("The Burnup Chart must be grouped by");
