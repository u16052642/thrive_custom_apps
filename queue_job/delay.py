...
def group(*delayables):
    ...
    Shortcut to :class:`~thrive.addons.queue_job.delay.DelayableGroup`.
...
def chain(*delayables):
    ...
    Shortcut to :class:`~thrive.addons.queue_job.delay.DelayableChain`.
...
class DelayableGraph(Graph):
    ...
    def _has_to_execute_directly(self, vertices):
        ...
        :func:`thrive.addons.queue_job.tests.common.trap_jobs`.
        """
...
class Delayable:
    ...
    by :meth:`~thrive.addons.queue_job.models.base.Base.delayable`. Look
...
class DelayableRecordset:
    ...
    This class will generally not be used directly, it is used internally
    by :meth:`~thrive.addons.queue_job.models.base.Base.with_delay`
    """
